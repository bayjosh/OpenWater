...
class MarineTraffic extends Component {
    ...
    loadTraffic = () => {
        ...
        postscribe('#script', `<script type='text/javascript'>width='100%'; height='100%'; border='1'; shownames='false'; latitude='${this.props.lat}'; longitude='${this.props.lon}'; zoom='10'; maptype='1'; trackvessel='0'; fleet=''; </script>`)
